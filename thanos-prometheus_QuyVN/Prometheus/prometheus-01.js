...
Prometheus.Graph.prototype.updateGraph = function() {
  ...
  var xAxis = new Rickshaw.Graph.Axis.Time({ graph: self.rickshawGraph, timeFixture: new Rickshaw.Fixtures.Time.Local()});
  ...
  var hoverDetail = new Rickshaw.Graph.HoverDetail({
    ...
    formatter: function(series, x, y) {
      // var date = '<span class="date">1' + new Date(x * 1000).toUTCString() + '</span>';
      var date = '<span class="date">' + new Date(x * 1000).toLocaleString({ timeZone: 'Europe/Helsinki' }) + '</span>';
